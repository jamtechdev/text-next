                ...
                <div className="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
                    <div className="relative flex flex-col md:flex-row">
                        ...
                        <nav className="flex flex-wrap items-center mb-5 text-base md:mb-0 md:pl-8 md:ml-8 md:border-l md:border-gray-200">
                            ...
                            <Link href={'/'} className="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Features</Link>
                            <Link href={'/'} className="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Pricing</Link>
                            <Link href={'/'} className="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Blog</Link>
                        </nav>
                    </div>
                    ...
                    <div className="inline-flex items-center ml-5 space-x-6 lg:justify-end">
                        ...
                        <Link href={'/'} className="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">
                            Sign up
                        </Link>
                    </div>
                </div>
                        ...
                        <div className="w-full md:w-1/2 md:px-3">
                            <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                ...
                                <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                                    ...
                                    <Link href={'/'} className="flex items-center px-6 py-3 text-gray-500 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600">
                                        Learn More
                                    </Link>
                                </div>
                            </div>
